...
{if $cryptonator_payments|count > 1}
    ...
    <div class="ty-control-group">{*
        <label class="ty-control-group__title" for="cryptonator_payment">{__("select_cryptonator_payment")}</label>
        <select name="payment_info[cryptonator_payment_type]" id="cryptonator_payment">
